...
cm_2_percentage = readPredTrue('pred_true.xlsx')
categories_2b = ['Left', 'Right'] 



# result_list = calculateConfusion('pred_true.xlsx')
result_list_2a = calculateConfusion('pred_true_2a.xlsx')
# cm_2_percentage = result_list.mean(axis=0)
cm_4_percentage = result_list_2a.mean(axis=0)
